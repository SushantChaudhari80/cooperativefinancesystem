...
{
	out.print("<script>alert('Loan Request Send Successfully..!')</script>");
}
						...
						<table class="table">
							<tr>
								...
								<td><input type="number" class="form-control"
									placeholder="loan Amount" name="loan_amount" required></td>
							</tr>
							<tr>
								<th>Loan Reason</th>
								<td><textarea rows="3" cols="50" name="reason" required></textarea></td>
							</tr>
							<tr>
								<td></td>
