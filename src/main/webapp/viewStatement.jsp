	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12" align="center">
				<h1 style="color: blue;">View Statement</h1>
			</div>
		</div>
		<hr />
		<div class="row">
				...
				<div class="table-responsive">
					<table class="table">
						<tr>
							...
							<th>Benefiiary Account Number</th>
							<th>IEFC</th>
							<th>Bank Name</th>
						</tr>
						<%
							...
							PreparedStatement ps = con.prepareStatement("SELECT * FROM transaction where u_id=?");
							ps.setString(1, u_id);
						...
						<tr>
							<td><%=i %></td>
							<td><%=rs.getString("trn_amount") %></td>
							<td><%=rs.getString("be_acc") %></td>
							<td><%=rs.getString("b_iefc") %></td>
