...
<body>
	...
	<div class="container">
		...
		<h1 align="center" style="color: blue;">Transfer Money</h1>

		<div class="row">
			<form action="transferMoney" method="POST" name="ureg" enctype="multipart/form-data">
		    <label>Enter Amount</label><br>
		    <input type="number" name="amount"/><br>
		     <input type="hidden" name="u_id" value="<%= session.getAttribute("u_id") %>"/>
		     <label>Enter Beneficiarry Account Number</label><br>
		    <input type="number" name="be_acc"/><br>
		    <label>IEFC code</label><br>
		    <input type="text" name="iefc"/><br>
		      <label>Bank Name</label><br>
		    <input type="text" name="b_name"/><br>
		   <input type="submit" style="width: 130px;" value="Submit" class="btn btn-success">
            </form>
		</div> 
	</div>
	</section>
