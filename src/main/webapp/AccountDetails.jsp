...
<body>
	...
	<div class="container">
		...
		<h1 align="center" style="color: blue;">AccountDetails</h1>
		...
		<div class="row">
			...
			<%
				...
				Map<String,String> u_details=gf.getAccountDeatils(u_id);
				...
				<div class="table-responsive">
					<table class="table">
						<tr>
							...
							<td><%=u_details.get("accountNumber")%></td>
						</tr>
						<tr>
							<th>Amount</th>
							<td><%=u_details.get("amount")%></td>
						</tr>
